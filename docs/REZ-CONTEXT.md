...
1. `rez-core-changes` — externalRef on Party (done), MysqlReservationRepository + ReservationSerializer external_ref (done), SeedDatabaseRequest accepts string[] (pending)
